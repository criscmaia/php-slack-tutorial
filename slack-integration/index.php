	...
	<body>
		...
		<?php else : ?>
			<p>
				...
				<a href="https://slack.com/oauth/authorize?scope=identity.basic&client_id=<?php echo $slack->get_client_id(); ?>"><img alt="Sign in with Slack" height="40" width="172" src="https://platform.slack-edge.com/img/sign_in_with_slack.png" srcset="https://platform.slack-edge.com/img/sign_in_with_slack.png 1x, https://platform.slack-edge.com/img/sign_in_with_slack@2x.png 2x" /></a>
				<a href="https://slack.com/oauth/authorize?scope=incoming-webhook&client_id=98256357858.118198252562"><img alt="Add to Slack" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcset="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a>
			</p>
		<?php endif; ?>
